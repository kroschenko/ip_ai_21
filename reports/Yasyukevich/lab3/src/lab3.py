...
annotations_file_train = r"C:\Users\darac\OneDrive\Рабочий стол\Новая папка (5)\rtsd-d3-gt\main_road\train_gt.csv"
annotations_file_test = r"C:\Users\darac\OneDrive\Рабочий стол\Новая папка (5)\rtsd-d3-gt\main_road\test_gt.csv"
images_dir_train = r"C:\Users\darac\OneDrive\Рабочий стол\Новая папка (5)\rtsd-d3-frames\train"
images_dir_test = r"C:\Users\darac\OneDrive\Рабочий стол\Новая папка (5)\rtsd-d3-frames\test"
